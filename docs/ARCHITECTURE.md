...
- Editor handler implementations are being decomposed into focused translation units (for example, `NovaBridgeOptimizeHandlers.cpp`, `NovaBridgeSequencerHandlers.cpp`, `NovaBridgeSceneHandlers.cpp`) instead of one monolithic module file.
